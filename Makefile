...
# Enterprise versions
ifneq ($(VM_ENTERPRISE),)
VM_CLUSTER_ENTERPRISE_VERSION := v1.148.0-enterprise-cluster
VM_SINGLE_ENTERPRISE_VERSION := v1.148.0-enterprise
...
VM_CLUSTER_CURRENT_LTS_VERSION := v1.136.14-enterprise-cluster
