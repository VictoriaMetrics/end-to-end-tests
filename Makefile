...
# Image versions
VM_K8S_STACK_CHART_VERSION = 0.92.0
...
# Enterprise versions
ifneq ($(VM_ENTERPRISE),)
VM_CLUSTER_ENTERPRISE_VERSION := v1.151.0-enterprise-cluster
VM_SINGLE_ENTERPRISE_VERSION := v1.151.0-enterprise
...
ifneq ($(VM_RC),)
VM_CLUSTER_RC_VERSION := v1.151.0-cluster-rc0
...
VM_CLUSTER_CURRENT_LTS_VERSION := v1.136.17-enterprise-cluster
