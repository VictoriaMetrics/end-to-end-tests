...
VM_VMSINGLEDEFAULT_VERSION ?= v1.140.0
VM_VMCLUSTERDEFAULT_VERSION ?= v1.140.0-cluster

ifneq ($(VM_ENTERPRISE),)
VM_VMSINGLEDEFAULT_VERSION := v1.140.0-enterprise
VM_VMCLUSTERDEFAULT_VERSION := v1.140.0-enterprise-cluster
endif

ifneq ($(VM_RC),)
VM_VMCLUSTERDEFAULT_VERSION := v1.139.0-cluster-rc2
endif
