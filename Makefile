...
VM_DISTRIBUTED_CHART_VERSION = 0.38.0
...
# Enterprise versions
ifneq ($(VM_ENTERPRISE),)
VM_CLUSTER_ENTERPRISE_VERSION := v1.144.0-enterprise-cluster
VM_SINGLE_ENTERPRISE_VERSION := v1.144.0-enterprise
...
VM_CLUSTER_CURRENT_LTS_VERSION := v1.136.10-enterprise-cluster
