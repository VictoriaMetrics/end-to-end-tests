...
# Image versions
VM_K8S_STACK_CHART_VERSION = 0.74.1
VM_DISTRIBUTED_CHART_VERSION = 0.35.0

OPERATOR_REGISTRY ?= quay.io
OPERATOR_REPOSITORY ?= victoriametrics/operator
OPERATOR_TAG ?= v0.68.3

VM_SINGLEDEFAULT_VERSION ?= v1.140.0
VM_CLUSTERDEFAULT_VERSION ?= v1.140.0-cluster

# Enterprise versions
ifneq ($(VM_ENTERPRISE),)
VM_CLUSTER_ENTERPRISE_VERSION := v1.140.0-enterprise
VM_SINGLE_ENTERPRISE_VERSION := v1.140.0-enterprise
...
VM_CLUSTER_CURRENT_LTS_VERSION := v1.136.5-cluster-enterprise
VM_SINGLE_CURRENT_LTS_VERSION := v1.136.5-enterprise

VM_SINGLEDEFAULT_VERSION := $(VM_CLUSTER_CURRENT_LTS_VERSION)
VM_CLUSTERDEFAULT_VERSION := $(VM_SINGLE_CURRENT_LTS_VERSION)
endif

ifeq ($(VM_LTS_VERSION),previous)
VM_CLUSTER_PREVIOUS_LTS_VERSION := v1.122.20-cluster-enterprise
VM_SINGLE_PREVIOUS_LTS_VERSION := v1.122.20-enterprise

VM_SINGLEDEFAULT_VERSION := $(VM_CLUSTER_PREVIOUS_LTS_VERSION)
VM_CLUSTERDEFAULT_VERSION := $(VM_SINGLE_PREVIOUS_LTS_VERSION)
endif
