...
# Image versions
VM_K8S_STACK_CHART_VERSION = 0.79.1
...
# Enterprise versions
ifneq ($(VM_ENTERPRISE),)
VM_CLUSTER_ENTERPRISE_VERSION := v1.128.0-enterprise-cluster
VM_SINGLE_ENTERPRISE_VERSION := v1.128.0-enterprise
...
VM_SINGLE_RC_VERSION := v1.144.0-enterprise-cluster-rc0
