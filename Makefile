...
# Image versions
VM_K8S_STACK_CHART_VERSION = 0.85.10
VM_DISTRIBUTED_CHART_VERSION = 0.40.0

OPERATOR_REGISTRY ?= quay.io
OPERATOR_REPOSITORY ?= victoriametrics/operator
OPERATOR_TAG ?= v0.73.0

VM_SINGLEDEFAULT_VERSION ?= v1.147.0
VM_CLUSTERDEFAULT_VERSION ?= v1.147.0-cluster

# Enterprise versions
ifneq ($(VM_ENTERPRISE),)
VM_CLUSTER_ENTERPRISE_VERSION := v1.147.0-enterprise-cluster
VM_SINGLE_ENTERPRISE_VERSION := v1.147.0-enterprise
...
ifneq ($(VM_RC),)
VM_CLUSTER_RC_VERSION := v1.147.0-cluster-rc1
...
VM_CLUSTER_CURRENT_LTS_VERSION := v1.136.13-enterprise-cluster
...
VM_CLUSTER_PREVIOUS_LTS_VERSION := v1.122.26-enterprise-cluster
