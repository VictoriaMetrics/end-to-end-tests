...
# Image versions
VM_K8S_STACK_CHART_VERSION = 0.76.0
VM_DISTRIBUTED_CHART_VERSION = 0.36.0

OPERATOR_REGISTRY ?= quay.io
OPERATOR_REPOSITORY ?= victoriametrics/operator
OPERATOR_TAG ?= v0.69.0

VM_SINGLEDEFAULT_VERSION ?= v1.142.0
VM_CLUSTERDEFAULT_VERSION ?= v1.142.0-cluster

# Enterprise versions
ifneq ($(VM_ENTERPRISE),)
VM_CLUSTER_ENTERPRISE_VERSION := v1.140.0-cluster-enterprise
VM_SINGLE_ENTERPRISE_VERSION := v1.142.0-enterprise
...
VM_CLUSTER_CURRENT_LTS_VERSION := v1.136.7-cluster-enterprise
VM_SINGLE_CURRENT_LTS_VERSION := v1.136.7-enterprise
...
VM_CLUSTER_PREVIOUS_LTS_VERSION := v1.122.21-cluster-enterprise
VM_SINGLE_PREVIOUS_LTS_VERSION := v1.122.21-enterprise
