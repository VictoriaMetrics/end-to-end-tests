...
# Image versions
VM_K8S_STACK_CHART_VERSION = 0.81.0
...
VM_SINGLEDEFAULT_VERSION ?= v1.144.0
VM_CLUSTERDEFAULT_VERSION ?= v1.144.0-cluster
...
ifneq ($(VM_RC),)
VM_CLUSTER_RC_VERSION := v1.144.0-cluster-rc0
...
VM_CLUSTER_PREVIOUS_LTS_VERSION := v1.122.23-enterprise-cluster
