...
# Image versions
VM_K8S_STACK_CHART_VERSION = 0.82.0
VM_DISTRIBUTED_CHART_VERSION = 0.39.0

OPERATOR_REGISTRY ?= quay.io
OPERATOR_REPOSITORY ?= victoriametrics/operator
OPERATOR_TAG ?= v0.70.1

VM_SINGLEDEFAULT_VERSION ?= v1.145.0
VM_CLUSTERDEFAULT_VERSION ?= v1.145.0-cluster

# Enterprise versions
ifneq ($(VM_ENTERPRISE),)
VM_CLUSTER_ENTERPRISE_VERSION := v1.145.0-enterprise-cluster
VM_SINGLE_ENTERPRISE_VERSION := v1.145.0-enterprise
...
ifneq ($(VM_RC),)
VM_CLUSTER_RC_VERSION := v1.145.0-cluster-rc0
...
VM_CLUSTER_CURRENT_LTS_VERSION := v1.136.11-enterprise-cluster
...
VM_CLUSTER_PREVIOUS_LTS_VERSION := v1.122.24-enterprise-cluster
