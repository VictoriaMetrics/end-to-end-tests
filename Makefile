...
OPERATOR_TAG ?= v0.72.0

VM_SINGLEDEFAULT_VERSION ?= v1.146.0
VM_CLUSTERDEFAULT_VERSION ?= v1.146.0-cluster

# Enterprise versions
ifneq ($(VM_ENTERPRISE),)
VM_CLUSTER_ENTERPRISE_VERSION := v1.146.0-enterprise-cluster
VM_SINGLE_ENTERPRISE_VERSION := v1.146.0-enterprise
